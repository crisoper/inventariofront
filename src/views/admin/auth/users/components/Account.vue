    ...
    >
      <div v-loading="loadingData" class="p-3">
        <el-row :gutter="1">
          ...
          <el-col :xs="24" :sm="24" :md="24">
            <el-form-item label="DNI" prop="persona_dni">
              <el-input v-model="userModel.persona_dni" readonly />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24">
            <el-form-item label="Nombre" prop="persona_full_name">
              <el-input v-model="userModel.persona_full_name" readonly />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      reglasValidacion: {
        persona_dni: [ { required: true, trigger: 'blur', message: 'Campo requerido' }],
        persona_full_name: [ { required: true, trigger: 'blur', message: 'Campo requerido' }],
