    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" border :data="tableData" style="width: 100%" >
        ...
        <el-table-column fixed="right" align="center" width="140" >
          <template #header>
            <el-button type="primary" plain @click="addItem()" v-permission="['inventario.inventarios.crear']">
              <template #icon>
                <v-icon name="ri-add-fill" />
              </template>
            </el-button>
            <el-button type="primary" plain @click="exportarDatos()" v-permission="['inventario.inventarios.exportar']">
              <template #icon>
          ...
          <template #default="scope">
            <div>
              <el-icon @click="verDetalle(scope.row)" color="#409EFC" size="18px" class="icon-btn pointer" title="Detalle">
                <List />
              </el-icon>
