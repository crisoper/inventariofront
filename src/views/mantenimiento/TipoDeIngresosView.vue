<template>
  <el-card v-loading="loadingData" shadow="never">
    ...
    >
      <CrearTipoIngreso ref="refCrearTipoBien" @close="cerrarDialago" />
    </el-dialog>
    <!-- Editar tipo de bien -->
...
import EditarTipoIngreso from "./components/EditarTipoIngreso.vue";
import CrearTipoIngreso from "./components/CrearTipoIngreso.vue";
import { Edit, Delete } from "@element-plus/icons-vue";
import Resource from "@/api/resource";
const tipoIngresoResource = new Resource("inventario/tipoingresos");
const exportResource = new Resource("exportar/tipoingresos");
export default {
  name: "TipoDeIngresosView",
  components: { CrearTipoIngreso, EditarTipoIngreso, Edit, Delete },
  data() {
    return {
      loading: false,
      query: {
